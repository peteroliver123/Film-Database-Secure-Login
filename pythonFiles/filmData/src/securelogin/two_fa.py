...
def unlock_two_fa(session):
    ...
    user_otp = secure_input("Enter the onetime passcode on your two factor app (NO SPACES):\n")
...
def two_fa_option():
    while True:
        ...
        result = secure_input("This will be needed for account recovery and reset: (Y/N): ")
